...
// راه‌اندازی با تنظیمات پایداری بیشتر
...
console.log("🔥 ARENA VIP BOT IS RUNNING WITH STABLE POLLING...");
...
// مدیریت خطاهای پولینگ که باعث قطعی می‌شدند
bot.on("polling_error", (error) => {
    console.log(`⚠️ Polling error occurred: ${error.code} - ${error.message}`);
});
